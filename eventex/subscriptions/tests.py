...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('andersonoanjo18@gmail.com', email.body)
        self.assertIn('91-984593967', email.body)
...
class SubscribeSuccessMessage(TestCase):
    def setUp(self):
        data = dict(name="Anderson Marques", cpf="01234567891",
                    email="andersonoanjo18@gmail.com", phone="91-984593967")
        self.resp = self.client.post('/inscricao/', data, follow=True) # para seguir o redirecionamento

    def test_message(self):
        """Success message must be 'Inscrição realizada com sucesso!'"""
